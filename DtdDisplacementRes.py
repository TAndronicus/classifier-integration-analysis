class DtdDisplacementRes:
    ...
    def __init__(self,
        ...
        self.i_vol_acc_std = i_vol_acc_std
        self.i_vol_mcc = i_vol_mcc
        self.i_vol_mcc_std = i_vol_mcc_std
        self.wmv_inv_acc = wmv_inv_acc
        self.wmv_inv_mcc = wmv_inv_mcc
        self.i_inv_acc = i_inv_acc
        self.i_inv_acc_std = i_inv_acc_std
        self.i_inv_mcc = i_inv_mcc
        self.i_inv_mcc_std = i_inv_mcc_std
        self.n_clf = n_clf
        self.n_fea = n_fea
